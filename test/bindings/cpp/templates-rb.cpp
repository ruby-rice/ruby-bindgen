...
void Init_Templates()
{
  ...
  Rice::Data_Type<Tests::Variant<Tests::AliasOptional<int> *, Tests::AliasOptional<float> *>> rb_cAliasVariant = Variant_instantiate<Tests::AliasOptional<int> *, Tests::AliasOptional<float> *>(rb_mTests, "AliasVariant");
