...
void Init_CrossFileBase()
{
  ...
  Rice::Data_Type<CrossFile::ForwardVec<double, 2>> rb_cEarlyForwardVec2d = ForwardVec_instantiate<double, 2>(rb_mCrossFile, "EarlyForwardVec2d");

  Rice::Data_Type<CrossFile::ForwardVec<double, 4>> rb_cForwardVec4d = ForwardVec_instantiate<double, 4>(rb_mCrossFile, "ForwardVec4d");
