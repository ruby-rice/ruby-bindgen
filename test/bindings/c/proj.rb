...
module Proj
  ...
  attach_function :proj_list_units, :proj_list_units, [], PJ_UNITS.by_ref
  attach_function :proj_list_angular_units, :proj_list_angular_units, [], PJ_UNITS.by_ref
  ...
  attach_function :proj_rtodms, :proj_rtodms, [:string, :double, :int, :int], :string
