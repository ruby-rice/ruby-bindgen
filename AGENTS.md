...
All 16 Rice tests: classes, enums, functions, inheritance, templates, constructors, operators, default_values, iterators, template_inheritance, overloads, incomplete_types, filtering, template_defaults, buffers, cross_file_typedef
